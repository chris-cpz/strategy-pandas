...
[![GitHub Stars](https://img.shields.io/github/stars/chris-cpz/strategy-pandas?style=for-the-badge&logo=github)](https://github.com/chris-cpz/strategy-pandas)
...
```bash
# Clone repository
git clone https://github.com/chris-cpz/strategy-pandas.git
cd strategy-pandas
...
```python
from strategy import pandasStrategy

# Initialize strategy
strategy = pandasStrategy()
...
- **Documentation**: [Wiki](https://github.com/chris-cpz/strategy-pandas/wiki)
- **Issues**: [GitHub Issues](https://github.com/chris-cpz/strategy-pandas/issues)
- **Discussions**: [GitHub Discussions](https://github.com/chris-cpz/strategy-pandas/discussions)
